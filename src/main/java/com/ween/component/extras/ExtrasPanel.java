package com.ween.component.extras;
...
public class ExtrasPanel extends JPanel {
	...
	private void initRainbowIcon() {
		FlatSVGIcon icon = new FlatSVGIcon( "com/ween/icons/informationDialog.svg" );
	...
	private void addSVGIcon( String name ) {
		svgIconsPanel.add( new JLabel( new FlatSVGIcon( "com/ween/icons/" + name ) ) );
	}
