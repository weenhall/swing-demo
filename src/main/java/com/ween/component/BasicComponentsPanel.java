...
public class BasicComponentsPanel extends JPanel{
	...
	public BasicComponentsPanel(){
		...
		// match case button
		JToggleButton matchCaseButton = new JToggleButton( new FlatSVGIcon( "com/ween/icons/matchCase.svg" ) );
		matchCaseButton.setRolloverIcon( new FlatSVGIcon( "com/ween/icons/matchCaseHovered.svg" ) );
		matchCaseButton.setSelectedIcon( new FlatSVGIcon( "com/ween/icons/matchCaseSelected.svg" ) );
		matchCaseButton.setToolTipText( "Match Case" );

		// whole words button
		JToggleButton wordsButton = new JToggleButton( new FlatSVGIcon( "com/ween/icons/words.svg" ) );
		wordsButton.setRolloverIcon( new FlatSVGIcon( "com/ween/icons/wordsHovered.svg" ) );
		wordsButton.setSelectedIcon( new FlatSVGIcon( "com/ween/icons/wordsSelected.svg" ) );
		wordsButton.setToolTipText( "Whole Words" );

		// regex button
		JToggleButton regexButton = new JToggleButton( new FlatSVGIcon( "com/ween/icons/regex.svg" ) );
		regexButton.setRolloverIcon( new FlatSVGIcon( "com/ween/icons/regexHovered.svg" ) );
		regexButton.setSelectedIcon( new FlatSVGIcon( "com/ween/icons/regexSelected.svg" ) );
	...
	private void initComponents(){
		...
		JButton button10=new JButton();
		{
			...
			button3.putClientProperty("JButton.buttonType","square");
			add(button3,"cell 3 1");
			button4.setText("Round");
			button4.putClientProperty("JButton.buttonType","roundRect");
			button5.setText("Help");
			button5.putClientProperty("JButton.buttonType","help");
			add(button5,"cell 4 1");
			button6.setText("Help");
			button6.putClientProperty("JButton.buttonType","help");
			button6.setEnabled(false);
			add(button6,"cell 4 1");
			button7.setIcon(UIManager.getIcon("Tree.closedIcon"));
			add(button7,"cell 5 1");
			button8.setText("...");
			add(button8,"cell 5 1");
			button9.setText("\u2026");
			add(button9,"cell 5 1");
			button10.setText("#");
			add(button10,"cell 5 1");
